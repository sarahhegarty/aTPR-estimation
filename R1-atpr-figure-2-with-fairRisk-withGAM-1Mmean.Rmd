...
shortstack <- stack.sum %>%
     ...
     mutate(alab = factor(a2,levels = c("-0.5","-0.25","0","0.25","0.5")
             ...
             ,blab = paste0("b[2]: ",b2) 
             ,Setting = factor(setting_id, levels = c(1,5,16,20), labels =c("Fair-1","Unfair-1","Fair-2","Unfair-2"))
            ,Reference =factor(refgp, levels = c(1,2), labels = c("Reference: 1", "Reference: 2"))  )
...
shortbench1M <- bench1Mgam%>%
   ...
   mutate(alab = factor(a2,levels = c("-0.5","-0.25","0","0.25","0.5")
          ...
          ,blab = paste0("b[2]: ",b2)
          ,Setting = factor(setting_id, levels = c(1,5,16,20), labels = c("Fair-1","Unfair-1","Fair-2","Unfair-2"))
          ,Reference =factor(ref, levels = c(1,2), labels = c("Reference: 1", "Reference: 2")) )
```
