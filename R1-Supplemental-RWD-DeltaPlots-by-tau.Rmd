...
# Save plot
ggsave(paste0("supfigs/dTPR-Forest_",simlab,"gender.eps"),height=4,width=6, dpi = 300)
```
...
# Save plot
ggsave(paste0("supfigs/dTPR-Forest_",simlab,"race.eps"),height=4,width=6, dpi = 300)
```
...
# Save plot
ggsave(paste0("supfigs/dTPR-Forest_",simlab,"genderrace.eps"),height=8,width=6, dpi = 300)
```