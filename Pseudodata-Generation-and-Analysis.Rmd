...
subtitle: "aTPR - PNAS manuscript (revision) Psuedodata Generation & Analysis"
...
ggsave(file=paste0(figout,"Psuedo-PC-Gender-tripanel-PNAS-bottomlegend2.eps"),dpi=300,height=6,width=6)
```
...
# Save plot
ggsave(paste0("pseudo-figs/dTPR-Forest_",simlab,"gender.png"),height=4,width=6, dpi = 300)
```
...
# Save plot
ggsave(paste0("pseudo-figs/dTPR-Forest_",simlab,"race.png"),height=4,width=6, dpi = 300)
```
...
# Save plot
ggsave(paste0("pseudo-figs/dTPR-Forest_",simlab,"genderrace.png"),height=8,width=6, dpi = 300)
```