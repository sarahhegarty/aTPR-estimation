  ...
  for(sigeps in c(0.1,0.2)){
    for(n in params$nlist){
     ...
     diffs.adj2 %>%
        ...
        theme_bw() + 
        scale_color_manual(name='Estimation Method', values = colorslist) +
        ylab('Sample Quantiles') +
        xlab('Theoretical Quantiles') 
  ggsave(paste0('supfigs/QQplots_alpha24_aTPR_',toupper(substr(h,1,1)),sigeps*10,'-',n,'.eps'), height=8,width=7)
   ...
   diffs.adj2 %>%
       filter( h2 == h
        ...
        ylab('Sample Quantiles') +
        xlab('Theoretical Quantiles') 
    ggsave(paste0('supfigs/QQplots_alpha24_aTPR_stdized_',toupper(substr(h,1,1)),sigeps*10,'-',n,'.eps'), height=8,width=7)
